...
const   guestFilters = require("../../../utilities/filterUtilities/allowedFilters/guestFilters.json");
...
{
    console.log("FILTRI RICHIESTI IN GUEST");
    const allowedFilters = guestFilters;
